            ...
            <div className="space-y-1">
              ...
              >
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                  pathname === '/a-propos' ? 'bg-white/20' : 'bg-gray-100'
                }`}>
                  <svg className={`w-5 h-5 ${pathname === '/a-propos' ? 'text-white' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              >
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                  pathname === '/recherche' ? 'bg-white/20' : 'bg-gray-100'
                }`}>
                  <svg className={`w-5 h-5 ${pathname === '/recherche' ? 'text-white' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
