...
import { HDS_DEV_BANNER } from '@/lib/family/coffre-fort';
 ...
 *
 * Note : un composant équivalent existe dans la feature B1 (journal). On
 * duplique ici pour éviter une dépendance inter-features.
 */
