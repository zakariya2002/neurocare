        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Commission uniquement au résultat</h3>
              <p className="text-gray-500 text-sm leading-relaxed">10&nbsp;% prélevés sur le rendez-vous confirmé, jamais avant. Zéro frais fixe.</p>
            </div>
          </div>
        </div>
      </section>
