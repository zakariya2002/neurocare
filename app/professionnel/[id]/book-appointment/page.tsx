              ...
              <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 space-y-6 border border-gray-100">
                ...
                <div className="rounded-lg p-4" style={{ backgroundColor: 'rgba(2, 126, 126, 0.05)', border: '1px solid rgba(2, 126, 126, 0.2)' }}>
                  ...
                  <p className="text-xs text-gray-700">
                    Conformément au RGPD, vous disposez d&apos;un droit d&apos;accès, de rectification et de suppression de vos données. Pour plus d&apos;informations, consultez notre <a href="/confidentialite" className="underline" style={{ color: '#027e7e' }}>politique de confidentialité</a>.
                  </p>
                </div>
