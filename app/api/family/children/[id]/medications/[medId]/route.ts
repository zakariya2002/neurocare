/**
 * API Médicaments d'un enfant (B1 — détail).
 *
 * PATCH  /api/family/children/[id]/medications/[medId]
 * DELETE /api/family/children/[id]/medications/[medId]
 */
...
export async function PATCH(
  ...
  const { id: childId, medId } = await params;
  ...
  if (!data) return NextResponse.json({ error: 'Médicament introuvable' }, { status: 404 });
