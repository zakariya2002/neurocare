              ...
              <div className="flex-1 overflow-y-auto">
                {conversations.length === 0 ? (
                  ...
                  conversations.map((conv) => {
                    ...
                    const profileUrl = isOtherEducator ? `/professionnel/${other?.id}` : (isOtherFamily ? `/family/${other?.id}` : null);
                ...
                <>
                  ...
                  <div className="p-4 border-b border-gray-100">
                    ...
                    {(() => {
                      ...
                      const profileUrl = isOtherEducator ? `/professionnel/${other?.id}` : (isOtherFamily ? `/family/${other?.id}` : null);
                      const appointmentUrl = isOtherEducator ? `/professionnel/${other?.id}/book-appointment` : (isOtherFamily ? `/family/${other?.id}/request-appointment` : null);
